...
PROVIDER = "MUNI_SUGANG_SEONGNAM_GO_KR_FAA99A7B"
PROVIDER_NAME = "성남 배움숲 수정구청 시민정보화교육"
OFFICE_CODE = "OFFICE_00000680"
OFFICE_BRANCH = "수정구청 시민정보화교육"
OFFICE_ADDRESS = "경기도 성남시 수정구 수정로 283"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Seongnam Baeumsoop Sujeong information education crawler")
